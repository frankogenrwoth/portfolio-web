...
Designed around scroll-snapped full-viewport sections so browsing feels like moving through a physical showpiece. Work and writing are first-class in the same rhythm: responsive image covers with config-driven backgrounds that adapt per project, motion kept subtle, and reduced-motion respected throughout.
